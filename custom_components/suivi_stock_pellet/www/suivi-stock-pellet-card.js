...
(function () {
  ...
  var STYLE = [
    ...
    ".calendar-nav { display: flex; align-items: center; justify-content: space-between; max-width: 260px; margin: 0 auto 6px auto; }",
    ...
    ".calendar-label { font-size: 0.7em; font-weight: 700; }",
